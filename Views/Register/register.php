            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image">
                        <div class="imagen-register">
                            <img src="Assets/img/dog_pruebaLogin.jpg" alt="" >
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user"
                                            id="VerificarContraseña" placeholder="Confirmar Contraseña">
                                    </div>
                                    
                                </div>
                                <div class="form-group">
                                    <input type="tel" class="form-control form-control-user" id="Correo"
