                ...
                <div class="modal-body">
                    <form id="formularioClientes" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="identificacion" name="identificacion" autocomplete="off">
                            <small id="small_nombre" class="form-text text-muted">Identificacion del cliente</small>
                        </div>
                        <div class="form-group">
