            ...
            <form>
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="small mb-1 ">id: <?= $data[0]['idInventario'] ?></div>
                        ...
                        <div class="d-flex">
                            <input class="form-control text-center me-2" id="inputQuantity" type="number" min="1" max="<?= $data[0]['cantidadProducto'] ?>" value="1" style="max-width: 5rem" />
