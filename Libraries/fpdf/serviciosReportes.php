...
class PDF extends FPDF 
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE SERVICIOS"), 0, 1, 'C');
      $this->Ln(7);
      ...
      $this->Cell(40, 10, utf8_decode('NOMBRE SERVICIO'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('PRECIO'), 1, 0, 'C', 1);
      $this->Cell(80, 10, utf8_decode('DESCRIPCIÓN'), 1, 1, 'C', 1);
...
$consulta_info = $conn->query('SELECT servicios.nombre_servicio,servicios.precio_servicio,servicios.descripcion_servicio
FROM servicios
...
if ($consulta_info && $consulta_info->num_rows > 0) {
    ...
    while ($dato_info = $consulta_info->fetch_object()) {
        $pdf->Cell(60);
        $pdf->Cell(40, 10, utf8_decode($dato_info->nombre_servicio), 1, 0, 'C');
        $pdf->Cell(40, 10, utf8_decode($dato_info->precio_servicio), 1, 0, 'C');
        $pdf->Cell(80, 10, utf8_decode($dato_info->descripcion_servicio), 1, 1, 'C');
    }
} else {
